...
contract('Wallet', (accounts)=>{
    ...
    it('should create transfers', async () => {
        ...
        assert(transfers[0].to.toString() === accounts[5]);

    });

    it('should NOT create transfers if sender is not approve', async () => {
        await expectRevert(wallet.createTransfer(100, accounts[5], {from: accounts[4]}), 'Only Approver');
    })
